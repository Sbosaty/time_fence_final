...
class EditAdmanScreen extends StatefulWidget {
  final UserModel userModel;
  const EditAdmanScreen({super.key, required this.userModel});

  @override
  State<EditAdmanScreen> createState() => _EditAdmanScreenState();
}

class _EditAdmanScreenState extends State<EditAdmanScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MaterialButton(
                        ...
                        height: 50,
                        child:  const Text('Edit Manger',style: TextStyle(
                            fontSize: 20
                        ),),
                      ):
